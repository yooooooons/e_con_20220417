...
mv_avg_duration_2 = 13

# close 가격 변동 비율에 따른 매수 / 매도 결정
mv_avg_ratio_buy_cri = 1.0021

#close_ratio_sell_cri = 0.9999
mv_avg_ratio_sell_cri = 0.99995

series_down = 17    # 몇개 이상의 시간대에서 moving_average가 하락세를 유지하는가  (13)
acceptable_rise = 1.0004   # series_down count중에, 최소값대비 어느정도 상승까지는 연속된 하락으로 인정하는가   (1.0008)

sell_ratio = [0.97, 1.042]
...
weight_avg_1 = 0.8   # mv_avg_duration_1 참조 비율
