...
mv_avg_ratio_buy_cri = 1.0015

close_ratio_sell_cri = 0.9999
mv_avg_ratio_sell_cri = 0.99995

series_down = 10    # 몇개 이상의 시간대에서 moving_average가 하락세를 유지하는가  (13)
acceptable_rise = 1.00025   # series_down count중에, 최소값대비 어느정도 상승까지는 연속된 하락으로 인정하는가   (1.0008)

sell_ratio = [0.975, 1.025]
...
weight_avg_1 = 0.73   # mv_avg_duration_1 참조 비율
